...
import 'package:chat_bloc_app/src/bloc/chat_bloc.dart';
import 'package:chat_bloc_app/src/model/chat_info.dart';
import 'package:chat_bloc_app/src/model/sticker.dart';
...
class ChatScreenState extends State<ChatScreen> {
  ...
  Widget buildSticker() {
    ...
    var sticker = Sticker(
        id: '1',
        collection: 'angry_cat',
        files: angryCatStickerFiles,
        fileType: 'png');
