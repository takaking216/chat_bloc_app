...
import 'package:chat_bloc_app/src/bloc/chat_list_bloc.dart';
import 'package:chat_bloc_app/src/model/chat_info.dart';
...
import 'package:chat_bloc_app/src/utils/util_nav.dart';
import 'package:chat_bloc_app/src/widgets/screen_chat.dart';
import 'package:chat_bloc_app/src/widgets/helper/NavBarMenuItem.dart';
                    ...
                    children: <Widget>[
                      Container(
                        child: Text(
                          user.name,
                          style:
                              TextStyle(color: textBlackColor, fontSize: 18.0),
                        ),
